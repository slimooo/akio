document.addEventListener("DOMContentLoaded", function() {
  ...
  // Zoom Image
  ======================= */
  const lightense = document.querySelector(".post img, .page img, .gallery__image img"),
  imageLink = document.querySelectorAll(".post a img, .page a img, .gallery__image a img");
  ...
  if (lightense) {
    Lightense(".post img:not(.no-lightense), .page img:not(.no-lightense), .gallery__image img:not(.no-lightense)", {
    padding: 60,
    offset: 30
    });
  }
